...
StoneShaderClass::StoneShaderClass(ID3D11Device* device, HWND hwnd)
{
	...
	result = InitializeShader(device, hwnd, L"shader/stone.vs", L"shader/stone.ps");
	if (!result)
	{
...
bool StoneShaderClass::InitializeShader(
	ID3D11Device* device, HWND hwnd, const WCHAR* vsFilename, const WCHAR* psFilename)
{
	...
	result = D3DCompileFromFile(vsFilename, NULL, NULL, "StoneVertexShader", "vs_5_0", D3D10_SHADER_ENABLE_STRICTNESS, 0,
	...
	result = D3DCompileFromFile(psFilename, NULL, NULL, "StonePixelShader", "ps_5_0", D3D10_SHADER_ENABLE_STRICTNESS, 0,
...
void StoneShaderClass::OutputShaderErrorMessage(
